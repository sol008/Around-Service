...
const (
	...
	DISTANCE    = "200km"
	ES_URL      = "http://35.235.75.25:9200"
	BUCKET_NAME = "oscar-post-images"
	API_PREFIX  = "/api/v1"
)
...
func saveToBigTable(p *Post, id string) error {
	...
	bt_client, err := bigtable.NewClient(ctx, "aroundsqoscarli", "around-post")
	if err != nil {
		return err
	}
...
//handler GET request sent to /cluster
